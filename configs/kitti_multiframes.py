...
_CN.MOFNetStack.GMA_MF = False

_CN.MOFNetStack.decoder_depth = 12
_CN.MOFNetStack.critical_params = ["cnet", "fnet", "pretrain", 'corr_fn', "Tfusion", "corr_levels", "decoder_depth", "mixed_precision", "GMA_MF"]
